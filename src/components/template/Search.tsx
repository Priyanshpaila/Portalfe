...
const ListItem = (props: { icon: string; label: string; url: string; isLast?: boolean; keyWord: string; onNavigate: () => void }) => {
        ...
        <Link to={url} onClick={onNavigate}>
            <div
                ...
                <div className='flex items-center'>
                    <div
                        className={classNames(
                            'mr-4 rounded-md ring-1 ring-slate-900/5 shadow-xs text-xl group-hover:shadow-sm h-6 w-6 flex items-center justify-center bg-white dark:bg-gray-700',
                            textTheme,
                            'dark:text-gray-100',
                        )}>
