...
export interface DateTimepickerProps
    extends CommonProps,
        Omit<CalendarSharedProps, 'onMonthChange' | 'onChange' | 'isDateInRange' | 'isDateFirstInRange' | 'isDateLastInRange' | 'month'>,
    ...
    return (
        <BasePicker
            ...
            <div className='flex items-center gap-4 mt-4'>
                <TimeInput disabled={!_value} value={_value} format={amPm ? '12' : '24'} clearable={false} size='sm' onChange={handleTimeChange} />
