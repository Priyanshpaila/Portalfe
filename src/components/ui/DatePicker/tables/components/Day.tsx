...
function getDayTabIndex({ focusable, hasValue, selected, firstInMonth }: { focusable: boolean; hasValue: boolean; selected: boolean; firstInMonth: boolean }) {
    if (!focusable) {
        return -1
    }
    ...
    return (
        <button
            ...
            className={classNames(
                ...
                inRange && !disabled && !firstInRange && !lastInRange && !selected && `bg-${themeColor}-${primaryColorLevel}/10`,
