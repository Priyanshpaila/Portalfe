...
import { useFloating, useInteractions, useDismiss, useRole, useFocus, useClick, useId, autoUpdate, offset, flip, shift } from '@floating-ui/react'
...
const BasePicker = forwardRef<HTMLInputElement, BasePickerProps>((props, ref) => {
    ...
    const { getReferenceProps, getFloatingProps } = useInteractions([inputtable ? focus : click, dismiss, role])
    ...
    return (
        <>
            ...
            />
            {dropdownOpened && (
                <div ref={refs.setFloating} className='picker !fixed' style={floatingStyles} aria-labelledby={headingId} {...getFloatingProps()}>
