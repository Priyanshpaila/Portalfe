...
const StepItem = forwardRef<HTMLDivElement, StepItemProps>((props, ref) => {
    const { className, customIcon, description, isLast, onStepChange, status, stepNumber, title, vertical, ...rest } = props
    ...
    const stepTitleClass = classNames('step-item-title', status === ERROR && `step-item-title-error`, onStepChange && status !== ERROR && `hover:text-${color}`)
