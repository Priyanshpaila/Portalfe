...
const Pagers = (props: PagersProps) => {
    ...
    return (
        <ul>
            ...
            {showPrevMore && <PrevMore className={classNames(pagerClass.default, pagerClass.inactive)} onArrow={(arrow) => onArrowClick(arrow)} />}
            ...
            {showNextMore && <NextMore className={classNames(pagerClass.default, pagerClass.inactive)} onArrow={(arrow) => onArrowClick(arrow)} />}
            {pageCount > 1 && (
