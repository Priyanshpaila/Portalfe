                        ...
                        <div className='flex-1 min-h-0 overflow-y-auto pr-1'>
                            <FormContainer>
                                ...
                                {initialValues.vendorCode && (
                                    <FormItem label='Vendor Status' labelClass='text-xs !mb-1' className='mb-2.5'>
                                        <div className='flex items-center justify-between rounded-xl border border-gray-200 bg-gray-50 px-3 py-2'>
                                            <div>
                                                <div className='text-sm font-semibold text-gray-800'>{Number(values.status) === 1 ? 'Active' : 'Inactive'}</div>
