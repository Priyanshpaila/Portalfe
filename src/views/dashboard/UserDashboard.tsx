        ...
        <div className='space-y-4 w-full min-w-0'>
            <div className='grid grid-cols-1 gap-4 sm:grid-cols-2 2xl:grid-cols-4'>
                <div className='w-full min-w-0 rounded-lg border border-gray-300 px-5 py-4'>
                    <span className='text-sm font-semibold'>Pending Indents</span>
                    <div className='mt-3.5 flex flex-wrap items-center gap-3.5'>
                        <span className='block text-2xl font-bold'>{stats?.pendingIndents}</span>
                        <Button
                            size='xs'
                            variant='twoTone'
                            className='flex shrink-0 items-center gap-2 rounded-3xl'
                            onClick={() => navigate('/indent-register')}
                        >
                            <span>View</span>
                ...
                <div className='w-full min-w-0 rounded-lg border border-gray-300 px-5 py-4'>
                    <span className='text-sm font-semibold'>Pending RFQs</span>
                    <div className='mt-3.5 flex flex-wrap items-center gap-3.5'>
                ...
                <div className='w-full min-w-0 rounded-lg border border-gray-300 px-5 py-4'>
                    <span className='text-sm font-semibold'>Unapproved POs</span>
                    <div>
                        <div className='mt-3.5 flex flex-wrap items-center gap-3.5'>
            ...
            <div className='flex w-full min-w-0 flex-col gap-4 xl:flex-row'>
                <div className='w-full min-w-0 overflow-hidden rounded-lg border border-gray-300 p-4'>
                    <div className='mb-3 flex flex-wrap items-center justify-between gap-2'>
                        ...
                        {userAuthority?.includes(PERMISSIONS.VIEW_QUOTATION) && (
                            <Button size='xs' variant='twoTone' className='flex items-center gap-1'>
                                <span>See All</span>
                                <MdOpenInNew size={16} />
                            </Button>
                        )}
                ...
                <div className='w-full min-w-0 overflow-hidden rounded-lg border border-gray-300 pt-4 pr-4'>
                    <POAmountChart amountTrend={amountTrend} />
                </div>
            </div>

            <div className='w-full min-w-0'>
                <span className='mb-3 inline-block text-sm font-semibold'>Expiring Indents</span>
                <div className='overflow-x-auto rounded-md border border-gray-200'>
                    <Table compact>
                        <THead>
                            <Tr>
            ...
            <div className='flex w-full min-w-0 flex-col gap-4 xl:flex-row'>
                <div className='w-full min-w-0'>
                    <span className='mb-3 inline-block text-sm font-semibold'>Latest POs</span>
                    <div className='overflow-x-auto rounded-md border border-gray-200'>
                        <Table compact>
                            <THead>
                                <Tr>
                ...
                <div className='w-full min-w-0'>
                    <span className='mb-3 inline-block text-sm font-semibold'>Latest RFQs</span>
                    <div className='overflow-x-auto rounded-md border border-gray-200'>
                        <Table compact>
                            <THead>
                                <Tr>
